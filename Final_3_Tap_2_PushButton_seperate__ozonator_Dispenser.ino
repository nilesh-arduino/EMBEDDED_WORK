...
//########################################################################################################################
//#                        <<   SMART THREE TAP TWO PUSH BUTTON WITH SEPERATE OZONATION BASED DISPENSER  >>              #
//# Developer:Nilesh Vyas                                                                                                #
//#                                                                                                                      #
//#                                                                                                                      #
//# << Dispenser Process >>                                                                                              #
//# 3 Tap 2 Push Button based seperate Ozonator Dispenser                                                                #
...
#define BOOSTER_PUMP_PIN                31
#define OZONATOR_PIN                    35//37
#define OZONATOR_PIN_1                  33//37
#define RST_PIN                         49
#define SS_PIN                          53
    ...
    {      
      ...
      if (IsDispensing == yes && dispense == yes)
      {
          ...
          if (currentMillis- dispenseMillis >= dispenseTimeout)//The value of dispenseTimeout can be configured.
          {
              ...
              TOTAL_VOLUME_DISPENSED += flowVolume/1000;
              flowVolume = 0;
              lcd1.clear();
...
WATER_ATM Tap2(SV1_PIN, FLOWSENSOR_2_PIN, OZONATOR_PIN_1, BOOSTER_PUMP_PIN);
WATER_ATM Tap3(SV3_PIN, FLOWSENSOR_3_PIN, OZONATOR_PIN_1, BOOSTER_PUMP_PIN);
    ...
    if((Tap1.IsDispensing==LOW && lastState_IsDispensing_tap1==HIGH) || (Tap2.IsDispensing==LOW && lastState_IsDispensing_tap2==HIGH) || (Tap3.IsDispensing==LOW && lastState_IsDispensing_tap3==HIGH)  )
    {
          ...
          if(Tap1.IsDispensing==LOW && lastState_IsDispensing_tap1==HIGH)
          {
                ...
                if(Tap1.dispensingComplete==HIGH)
                {
                    ...
                    lcd1.setCursor(2,1);
                    TOTAL_VOLUME_DISPENSED += (Tap1.Dispensed_Volume)/1000;
          ...
          else if(Tap2.IsDispensing==LOW && lastState_IsDispensing_tap2==HIGH && Tap3.IsDispensing==LOW && lastState_IsDispensing_tap3==HIGH)
          {
                ...
                {
                    TOTAL_VOLUME_DISPENSED += (Tap2.Dispensed_Volume)/1000;
